...
class DefaultMyProjectDetailPage2 extends StatefulWidget {
  final ProjectUnit project;
  const DefaultMyProjectDetailPage2({required this.project});

  @override
  State<DefaultMyProjectDetailPage2> createState() =>
      _DefaultMyProjectDetailPage2State();
}

class _DefaultMyProjectDetailPage2State
    extends State<DefaultMyProjectDetailPage2> {
  String token = '';
